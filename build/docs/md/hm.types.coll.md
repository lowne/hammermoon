...
* Class [`coll.list`](hm.types.coll.md#class-colllist)
  ...
  * [`sortByField(fieldName,inPlace)`](hm.types.coll.md#method-colllistsortbyfieldfieldnameinplace---colllist) -> [_`<#coll.list>`_](hm.types.coll.md#class-colllist) - method
